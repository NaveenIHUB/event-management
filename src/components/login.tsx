    ...
    <div className="min-h-screen bg-[#E5E7F3] flex items-center justify-center p-4">
      <div className="bg-[#F5F5F5] rounded-3xl p-8 w-full max-w-sm shadow-sm">
        ...
        <button
          ...
          className="mt-4 w-full bg-indigo-600 text-white rounded-md py-2 text-sm font-medium hover:bg-indigo-700 transition-colors"
        >
          Sign Up
        </button>
      </div>
...
//     <div className="min-h-screen bg-[#E5E7F3] flex items-center justify-center p-4">
//       <div className="bg-[#F5F5F5] rounded-3xl p-8 w-full max-w-sm shadow-sm">
//         <h1 className="text-center text-2xl font-bold text-blue-600 mb-6">Login</h1>
//         <form onSubmit={handleSubmit} className="space-y-4">
//           <div className="space-y-2">
//             <label className="block text-sm font-bold text-gray-700">Email</label>
//             <input
...
//         <button
//           onClick={() => router.push("/signup")}
//           className="w-full mt-4 bg-gray-300 text-black rounded-md py-2 text-sm font-medium hover:bg-gray-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-500 transition-colors"
//         >
//           Sign Up
//         </button>
//       </div>
